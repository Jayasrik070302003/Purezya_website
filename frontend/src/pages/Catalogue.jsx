...
const Catalogue = () => {
    ...
    return (
        <div className="min-h-screen pt-28 pb-6 md:pb-20 px-4 sm:px-8 lg:px-12 bg-[#F5F7F4] relative overflow-hidden font-sans selection:bg-organic-200 selection:text-organic-900">
            {/* Ambient Atmosphere */}
                ...
                {!searchQuery ? (
                    <div className="mb-fluid-2xl">
                        ...
                        >
                            ...
                            {/* Content */}
                            <div className="relative z-30 flex flex-col items-center px-4 max-w-4xl mx-auto mt-4 md:mt-8">
                                {/* Premium Tag */}
                                <motion.div
                        ...
                        <Link to={`/product/${item.id}`} key={item.id} className="group h-full">
                            ...
                            >
                                ...
                                <div className="relative h-[clamp(200px,30vw,280px)] rounded-fluid-xl overflow-hidden bg-gray-100 mb-4">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            {item.tag && (
                                                <motion.div
                                                    ...
                                                    className="bg-white/90 backdrop-blur-md text-[#122A14] text-[10px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full shadow-lg border border-white/20 self-start"
                                                >
                                                    {item.tag}
                                                </motion.div>
                                            )}
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 p-5 translate-y-2 group-hover:translate-y-0 transition-transform duration-500 z-10 leading-tight">
                                        <p className="text-[#C8E6C9] text-[10px] font-bold uppercase tracking-wider mb-1 flex items-center gap-1.5">
                                            <Sparkles size={10} className="text-[#A5D6A7]" />
                                            {item.count}
                                        </p>
                                        <h3 className="text-2xl font-display font-bold text-white leading-none mb-1 group-hover:text-[#E8F5E9] transition-colors shadow-black drop-shadow-md">
                                            {item.name}
                                        </h3>
                                        <p className="text-white/80 text-xs font-medium line-clamp-1 mb-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100 transform translate-y-2 group-hover:translate-y-0">
                                            {item.benefit}
                                        </p>
                                        ...
                                        <div className="flex items-center justify-between pt-3 border-t border-white/20">
                                            <div>
                                                <p className="text-white/60 text-[10px] uppercase font-bold tracking-wide">from</p>
                                                <p className="text-[#A5D6A7] font-bold text-base">{item.price}</p>
                                            </div>
                                            <motion.button
                                                onClick={(e) => {
                                                    e.preventDefault();
                                                ...
                                                whileTap={{ scale: 0.9 }}
                                                className="w-10 h-10 bg-white text-[#122A14] rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:scale-110 active:scale-95 transition-transform duration-300"
                                            >
                                                <ShoppingBag size={18} className="ml-0.5" />
                                            </motion.button>
                                        </div>
                                    </div>
                                </div>
