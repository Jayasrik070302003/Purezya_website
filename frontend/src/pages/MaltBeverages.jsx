                    ...
                    {allProducts.map((product, idx) => (
                        ...
                        >
                            <div className="relative h-32 md:h-64 rounded-[1rem] md:rounded-[2rem] overflow-hidden mb-2 md:mb-6 bg-earthy-50 group-hover:scale-[1.02] transition-transform duration-500">
                                ...
                                {idx === 0 && (
                                    <div className="absolute top-2 left-2 md:top-4 md:left-4 px-2 py-0.5 md:px-3 md:py-1 bg-organic-600/90 backdrop-blur text-white text-[9px] md:text-xs font-bold rounded-full uppercase tracking-widest pointer-events-none">
                                        Best Seller
                                    </div>
                                )}
